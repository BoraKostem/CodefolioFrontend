...
const EditBgPhotoPopup = ({ bgPhoto, onClose }) => {
    const [backgroundPhoto, setBackgroundPhoto] = useState(bgPhoto);
    ...
    const handleSave = async() => {
        ...
        try{
            ...
            if (!response.ok) {
                if (response.status === 401) {
                    ...
                    throw new Error('Failed to upload bg');
                }
                return;
            }
        ...
        console.log('Updated photo:', backgroundPhoto);
        onClose();
    }
        ...
        />
            ...
            <div className='codefoliobg-gray p-6 rounded-md'>
                ...
                <div className='flex flex-col items-center'>
                    {backgroundPhoto ? (
                        <img src={backgroundPhoto} alt="New Profile" className='w-24 h-24 rounded-full mb-4 object-cover'/>
                    ) : (
...
export default EditBgPhotoPopup
